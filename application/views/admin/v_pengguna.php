...
<?php echo base_url() ?>tampilan/gambar/jurusan.png"></td>
                  ...
                  <td style="text-align:right;">
                        ...
                        <a class="btn" data-toggle="modal"><span class="fa fa-pencil"></span></a>
                                               <a class="btn"><span class="fa fa-trash"></span></a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xnama" class="form-control" id="inputUserName" placeholder="Nama Lengkap" required onkeypress="return isCharKey(event)">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xkontak" class="form-control" id="inputUserName" placeholder="Kontak Person" required  onkeypress="return isNumberKey(event)">
                                        </div>
                                    </div>
                                    <div class="form-group">
