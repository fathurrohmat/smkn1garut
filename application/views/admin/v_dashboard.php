  ...
  <div class="content-wrapper">
    ...
    <?php }else if($this->session->userdata('akses')=='2'){ ?>
      <h1>
       ...
       <h3>Selamat Datang Kepala Sekolah</h3>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $total_agenda;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Kompetensi Keahlian</span>
              <span class="info-box-number"><?php echo $total_jurusan;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Kepengurusan Sekolah</span>
              <span class="info-box-number"><?php echo $total_pegawai;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
