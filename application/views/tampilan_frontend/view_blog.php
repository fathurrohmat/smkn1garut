                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="news-box">
                                    <div class="news-img-holder">
                                        <img src="<?php echo base_url().'assets/images/'.$row->tulisan_gambar;?>" style="width:200px; height:200px" class="img-responsive" alt="research">
                                        <ul class="news-date2">
                                            <li><?php echo date("d M", strtotime($row->tulisan_tanggal));?></li>
                                            <li><?php echo date("Y", strtotime($row->tulisan_tanggal));?></li>
                                        </ul>
                                    </div>
                                    <h3 class="title-news-left-bold"><a href="<?php echo site_url('artikel/'.$row->tulisan_slug);?>"><?php echo $row->tulisan_judul;?></a></h3>
