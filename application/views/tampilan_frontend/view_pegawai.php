...
<!-- Mirrored from www.radiustheme.com/demo/html/academics/academics/lecturers1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Jul 2020 08:07:48 GMT -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="inner-page-banner-area" style="background-image: url('<?php echo base_url() ?>tampilan/img/banner/pegawai.jpg');">
            <div class="container">
        ...
        <div class="lecturers-page1-area">
            <div class="container">
                ...
                <?php foreach ($data->result() as $row) : ?>
                  ...
                  <img src="<?php echo base_url().'assets/images/blank.png';?>"  class="img-responsive" alt="team" style="width:300px; height: 200px">
                  <?php else:?>
                  <img src="<?php echo base_url().'assets/images/'.$row->pegawai_photo;?>"  class="img-responsive" alt="team" style="width:300px; height: 200px">
                          <?php endif;?>
...
<!-- Mirrored from www.radiustheme.com/demo/html/academics/academics/lecturers1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Jul 2020 08:07:55 GMT -->
</html>
