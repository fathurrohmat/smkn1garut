...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="inner-page-banner-area" style="background-image: url('<?php echo base_url() ?>tampilan/img/banner/mengajar.jpg');">
            <div class="container">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="single-item">
                            <div class="lecturers1-item-wrapper">
                             ...
                             <img src="<?php echo base_url() ?>tampilan/gambar/jurusan.png"  class="img-responsive" alt="team" style="width:300px; height: 200px">
