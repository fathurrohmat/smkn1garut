...
<!-- Mirrored from www.radiustheme.com/demo/html/academics/academics/single-news.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Jul 2020 08:07:44 GMT -->
                        ...
                        <div class="row news-details-page-inner">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="news-img-holder">
                                    <img src="<?php echo base_url().'assets/images/'.$image?>" class="img-responsive" alt="research">
                                    
                                </div>
                                
                                <ul class="title-bar-high news-comments">
                                    <li><a href="#"><i class="fa fa-user" aria-hidden="true"></i><span>Oleh :</span> <?php echo $author;?></a></li>
                                    <li><a href="#"><i class="fa fa-calender" aria-hidden="true"></i><?php echo $tanggal;?></a></li>
                                ...
                                ?>
                                    <div class="media">
                                        <a href="#" class="pull-left">
                                            <img alt="Comments" src="<?php echo base_url() ?>tampilan/img/course/gambaruser.png" class="media-object" height='60' width='60' >
                                        </a>
                                        <div class="media-body">
                                            <h3><a href="#"><?php echo $row->komentar_nama;?></a></h3>
                                  ...
                                  ?> 
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h3><a href="#"><?php echo $res->komentar_nama;?></a></h3>
                                ...
                                <div class="leave-comments">
                                    <h3 class="sidebar-title">Berikan Komentar</h3>
                                    <div class="row">
                                        ...
                                        <?php echo $this->session->flashdata('msg');?>
                                            <form action="<?php echo site_url('blog/komentar');?>" method="post">
                                                <fieldset>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <textarea placeholder="Comment" name="komentar" class="textarea form-control" id="form-message" rows="8" cols="20"></textarea>
                                                            <div class="help-block with-errors"></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                    <input type="hidden" name="id" value="<?php echo $id;?>" required>
                                                        <div class="form-group margin-bottom-none">
                                                            <button type="submit" class="view-all-accent-btn">Berikan Komentar</button>
                                                        </div>
                                                    </div>
                                                </fieldset>
                                            </form>
...
<!-- Mirrored from www.radiustheme.com/demo/html/academics/academics/single-news.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Jul 2020 08:07:47 GMT -->
</html>
