...
<!-- Mirrored from www.radiustheme.com/demo/html/academics/academics/single-lecturers.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Jul 2020 08:07:55 GMT -->
        ...
        <div class="inner-page-banner-area" style="background-image: url('img/banner/5.jpg');">
            <div class="container">
                <div class="pagination-area">
                    <h3 style="color:white">Sambutan Bapak Kepala Sekolah SMKN 1 Garut</h3>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        ...
                        <div class="lecturers-contact-info">
                            <img src="<?php echo base_url() ?>tampilan/gambar/jurusan.png" class="img-responsive" alt="team">
                            <h2 style="font-size:20px">Bapak Kepala Sekolah</h2>
                            <h3 style="color:black">Kepala Sekolah SMKN 1 Garut</h3>
                            
                            
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                        <h3 class="title-default-left title-bar-big-left-close">Sambutan Bapak Kepala Sekolah</h3>
                        <p>Isi Sambutan</p>
...
<!-- Mirrored from www.radiustheme.com/demo/html/academics/academics/single-lecturers.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Jul 2020 08:07:56 GMT -->
</html>
